...
const UploadForm = ({ onUploadSuccess }) => {
    ...
    return (
        <div className="card">
            ...
            {message && (
                <div className={`mb-6 p-4 rounded-lg text-sm font-medium ${message.includes('success') ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 'bg-red-50 text-red-600 border border-red-100'}`}>
                    {message}
                </div>
            )}
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    ...
                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-slate-300 border-dashed rounded-lg hover:border-red-400 transition-colors bg-slate-50 hover:bg-slate-100">
                        <div className="space-y-1 text-center">
                            {file ? (
                                <div className="text-sm text-slate-600">
                                    <p className="font-semibold text-red-600">{file.name}</p>
