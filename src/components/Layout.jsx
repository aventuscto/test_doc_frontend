                        ...
                        <div className="hidden sm:ml-6 sm:flex sm:items-center">
                            <div className="ml-3 relative flex items-center gap-4">
                                ...
                                <button
                                    ...
                                    className="text-slate-500 hover:text-blue-600 transition duration-200 p-2 rounded-full hover:bg-slate-100"
                                    title="Logout"
                                >
                ...
                <div className={`${isMobileMenuOpen ? 'block' : 'hidden'} sm:hidden bg-white border-b border-slate-200`}>
                    ...
                    <div className="pt-4 pb-4 border-t border-slate-200">
                        <div className="flex items-center px-4">
                            ...
                            <button
                                onClick={handleLogout}
                                className="ml-auto flex-shrink-0 bg-white p-1 rounded-full text-slate-400 hover:text-blue-600"
                            >
